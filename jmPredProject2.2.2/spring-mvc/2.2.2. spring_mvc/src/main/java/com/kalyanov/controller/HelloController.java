...
import com.kalyanov.service.Servicee;
...
public class HelloController {
	...
	public String loopListExample(@RequestParam(value = "countCa", required = false) String counCa, Model model) {
        if (counCa == null || Integer.valueOf(counCa) >= 5) {
			model.addAttribute("people", servicee.getListCar());
			return "indexcar";
		} else {
			model.addAttribute("people", servicee.getCarCount(Integer.valueOf(counCa)));
			return "indexcar";
		}
	}
}